...
data = pd.read_excel(join(dirname(__file__), 'data/feuille de saisie METEO mois par mois.xlsx'), None, header = (0,1)) # header dans les deux premières lignes de chaque onglet
