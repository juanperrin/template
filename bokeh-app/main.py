...
data = pd.read_csv(join(dirname(__file__), 'data/feuille de saisie METEO mois par mois.csv'), None, header = (0,1)) # header dans les deux premières lignes de chaque onglet
